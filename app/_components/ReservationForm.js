...
function ReservationForm({ cabin, user }) {
  ...
  const createBooking = createReservationAction.bind(null, bookingData);
  return (
    <div className="scale-[1.01]  ">
      <div className="bg-primary-800 text-primary-300 px-16 py-7 flex justify-between items-center">
      ...
      >
        ...
        <div className="flex justify-end items-center gap-6">
          ...
          <UpdateButton type="Reserve">Now</UpdateButton>
        </div>
      </form>
    </div>
  );
